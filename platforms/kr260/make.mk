...
prebuilt_images_src:=$(wrkdir_src)/kria-firmware
...
uboot_kria_defconfig:=xilinx_zynqmp_virt_defconfig
$(eval $(call build-uboot, $(uboot_image), $(uboot_kria_defconfig)))

$(boot_bin): $(prebuilt_images_src) $(uboot_image)
	cp -fv $(wrkdir_plat_imgs)/u-boot.elf $</$(PLATFORM)-zynqmp
	@cd $</$(PLATFORM)-kria && bootgen -arch zynqmp -image bootgen.bif -w -o $@
